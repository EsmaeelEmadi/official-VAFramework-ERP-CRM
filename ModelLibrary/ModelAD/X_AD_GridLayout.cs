namespace VAdvantage.Model
{
    ...
    using System.Data;/** Generated Model for AD_GridLayout
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
    public class X_AD_GridLayout : PO
    {
        public X_AD_GridLayout(Context ctx, int AD_GridLayout_ID, Trx trxName) : base(ctx, AD_GridLayout_ID, trxName)
        {/** if (AD_GridLayout_ID == 0){SetAD_GridLayout_ID (0);SetAD_HeaderLayout_ID (0);} */
        }
        public X_AD_GridLayout(Ctx ctx, int AD_GridLayout_ID, Trx trxName) : base(ctx, AD_GridLayout_ID, trxName)
        {/** if (AD_GridLayout_ID == 0){SetAD_GridLayout_ID (0);SetAD_HeaderLayout_ID (0);} */
        }/** Load Constructor 
@param ctx context
@param rs result set 
...
*/
 ...
 added by ->Harwinder */
        ...
        static long serialVersionUID = 27930740164463L;/** Last Updated Timestamp 3/30/2022 10:04:07 AM */
        public static long updatedMS = 1648614847674L;/** AD_Table_ID=1001038 */
        public static int Table_ID; // =1001038;
...
@return Grid Layout */
        public int GetAD_GridLayout_ID() { Object ii = Get_Value("AD_GridLayout_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Template.
...
@return Total number of rows in block of panel */
        public int GetTotalRows() { Object ii = Get_Value("TotalRows"); if (ii == null) return 0; return Convert.ToInt32(ii); }
    }
}